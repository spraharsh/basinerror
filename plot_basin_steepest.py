...
if __name__ == "__main__":
    ...
    # quench_type = 'mixed_descent_200'
    # quench_type = 'fire_200'
    ...
    for z in z_list:
        ...
        print(percentage_same('cvode_200/z_data_30_l6_2/0.0', quench_type + '/z_data_30_l6_2/0.0', foldnameInversePower, minima_l=minima_l))
# if __name__ == "__main__":
#     ncolors = 30
